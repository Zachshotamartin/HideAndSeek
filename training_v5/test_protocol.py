"""Training distribution: reset randomization, role balance and the opponent archive."""
import unittest

import numpy as np

from protocol import (FAMILIES, LONG_PLAY, archive_exercised, archive_indices, assign_balanced_roles, environment_config,
                      extended_cohort)
...
class ProtocolTests(unittest.TestCase):
    ...
    def test_archive(self):
        ...
        self.assertIn(12, keep)
        self.assertTrue(set(range(32, 40)).issubset(keep))
        self.assertLessEqual(len(keep), 25)
    ...
    def test_extended_cohort_adds_long_play_maps_with_fresh_seeds(self):
        ...
        with self.assertRaises(ValueError):
            extended_cohort(base, seed_base=1750100000)
