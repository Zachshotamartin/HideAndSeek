...
FORMAT = 'original-mujoco-relational-policy-pair-v2'
ENTITY = 'object-relations-v2'
...
def export_actor(model):
    return dict(encoderType=ENTITY if isinstance(model, EntityActor) else LEGACY,
        observationSize=210, physicsObservationSize=208, hiddenSize=model.hidden_size, encoderSize=model.encoder_size,
